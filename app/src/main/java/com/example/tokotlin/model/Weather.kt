...
@Parcelize
data class Weather(var city: City = getDefaultCity(), val temperature:Int = 20, val feelsLike:Int = 22, val icon:String = "skc_n"):Parcelable
...
fun getRussianCities(): List<Weather> {
    return listOf(
        ...
        Weather(City("Белоозёрский", 55.2723, 38.2714))
    )
}